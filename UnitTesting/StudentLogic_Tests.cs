...
namespace UnitTesting
{
    ...
    public class StudentLogic_Tests
    {
        ...
        [TestMethod]
        public void StudentLoginReturnsTrue()
        {
            StudentLogic studentlogin = new StudentLogic();
            StudentLogin student = new StudentLogin();
            student.StudentId = 13;
            student.StudentPassword = "123";
            bool Isloggedin = studentlogin.IsLoggedIn(student);
        ...
        public void StudentRegisterReturnsTrue()
        {
            ...
            Assert.AreEqual(studentcheck.IsAlreadyLoggedIn(student), true);
        }
        [TestMethod]
        public void StudentDetailsReturnsTrue()
        {
            StudentRetrieve getStudent = new StudentRetrieve();
            Student student = getStudent.GetStudentDetails(123);

...
namespace UnitTesting
{
    ...
    public class AdminDb_Tests
    {
        ...
        public void IsAdminReturnsTrue()
        {
            ...
            AdminLogin admincheck = new AdminLogin();
            admincheck.AdminId = "admin";
            admincheck.AdminPassword = "admin";
            Assert.IsTrue(admin.IsAdmin(admincheck));
        }
        [TestMethod]
        public void IsAdminReturnsFalse()
        {
            ...
            AdminLogin admincheck = new AdminLogin();
            admincheck.AdminId = "admin";
            admincheck.AdminPassword = "admin123";
            Assert.IsFalse(admin.IsAdmin(admincheck));
        }

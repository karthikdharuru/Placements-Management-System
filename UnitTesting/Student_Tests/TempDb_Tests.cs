...
namespace UnitTesting
{
    ...
    public class TempDb_Tests
    {
        ...
        {
            TempStudentDb tempadmin = new TempStudentDb();
            Student student = tempadmin.RetrieveStudent("15721@gmail.com");
        ...
        {
            TempStudentDb tempadmin = new TempStudentDb();
            Student student = tempadmin.RetrieveStudent("12915117@gmail.com");
        ...
        public void deleterReturnsFalse()
        {
            ...
            Assert.AreEqual(tempadmin.DeleteStudent("1371453747@gmail.com"), true);
